...
<serviceModel xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" name="KvartaCloudIoTGateway" generation="1" functional="0" release="0" Id="09a8ee77-28d9-4aa0-83c5-5bea19061592" dslVersion="1.2.0.0" xmlns="http://schemas.microsoft.com/dsltools/RDSM">
  <groups>
    <group name="KvartaCloudIoTGatewayGroup" generation="1" functional="0" release="0">
      ...
      <components>
        <groupHascomponents>
          <role name="Gateway" generation="1" functional="0" release="0" software="C:\Dev\KvartaCloudIoTGateway\KvartaCloudIoTGateway\csx\Release\roles\Gateway" entryPoint="base\x64\WaHostBootstrapper.exe" parameters="base\x64\WaWorkerHost.exe " memIndex="-1" hostingEnvironment="consoleroleadmin" hostingEnvironmentVersion="2">
            <componentports>
  ...
  <implements>
    <implementation Id="b23e36f0-131b-4f10-8fef-3a8925ae8e05" ref="Microsoft.RedDog.Contract\ServiceContract\KvartaCloudIoTGatewayContract@ServiceDefinition">
      <interfacereferences>
        <interfaceReference Id="74fef073-2544-4a01-b8b4-5ca39ad4c957" ref="Microsoft.RedDog.Contract\Interface\Gateway:Microsoft.WindowsAzure.Plugins.RemoteForwarder.RdpInput@ServiceDefinition">
          <inPort>
            <inPortMoniker name="/KvartaCloudIoTGateway/KvartaCloudIoTGatewayGroup/Gateway:Microsoft.WindowsAzure.Plugins.RemoteForwarder.RdpInput" />
          </inPort>
        </interfaceReference>
        <interfaceReference Id="2af8d305-917a-4dbf-81a2-64ceb438a799" ref="Microsoft.RedDog.Contract\Interface\Gateway:TCPEndpoint@ServiceDefinition">
          <inPort>
            <inPortMoniker name="/KvartaCloudIoTGateway/KvartaCloudIoTGatewayGroup/Gateway:TCPEndpoint" />
          </inPort>
        </interfaceReference>
